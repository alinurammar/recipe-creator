            ...
            <div className="main-container">
                ...
                <div className="section">
                    ...
                    <div className="subtitle">
                        <ul>
                            <li>
                                <span>⏱️</span> Save time and effort by letting our algorithm do the hard work of recipe planning for you.
                            </li>
                            <li>
                                <span>🍽️</span> Discover new and exciting recipes that you may have never thought of before.
                            </li>
                            <li>
                                <span>🥑</span> Reduce food waste by using up ingredients you already have in your pantry.
                            </li>
                            <li>
                                <span>🥗</span> Adapt recipes to your dietary preferences, whether you're vegan, gluten-free, or have any other dietary restrictions.
                            </li>
                            <li>
                                <span>🎨</span> Get creative in the kitchen and experiment with different flavors and ingredients.
                            </li>
                        </ul>
                    </div>
